...
<div className="flex flex-wrap -mx-2 overflow-hidden xl:-mx-2">
  ...
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    <Image alt="Resultado de la api" src="/static/images/bascula/bascula-valores.jpeg" width={640} height={427} />
  </div>

  <video src="/static/images/bascula/bascula.mp4" width={640}  height={427} controls poster="vistaprevia.jpg">
  </video>
</div>
