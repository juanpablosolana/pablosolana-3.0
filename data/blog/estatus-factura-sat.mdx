...
date: '2021-08-04'
tags: ['Facturas', 'XML', 'Webservices','SAT','NodeJS', 'API']
draft: false
summary: 'Surgio un proyecto donde se deve consultar el webservice del SAT para validar el estatus de las facturas, por lo que me vi en la necesiadad de crear una API para poder validarlo'
---
